<div id="index-banner">
	<div class="container">
	  <div class="col-md-12 text-center">
	    <div class="row index-banner-registration quick-registration">
	      <div class="col-md-12 animated bounceInLeft">
	        <h1>
	          Tìm kiếm website
	        </h1>
	        <p class="slogan">
	          thietkeweb360 mang đến cho bạn những trang web đẹp
	        </p>
	      </div>
	    ...
	    <div>
	      <div class="col-xs-12 col-sm-12 col-md-12 home-banner">
	        <img class="autoresize-image" src="/themes/v1/images/banner/banner_new_1.png" />
	      </div>
	    </div>
	  </div>
	</div>
