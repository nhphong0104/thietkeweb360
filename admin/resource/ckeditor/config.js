...
CKEDITOR.editorConfig = function( config ) {
   ...
   // Cho phep them mot so the
	...
	// Them Plugin
	config.extraPlugins = 'mdn-buttons,mdn-sampler,mdn-keystrokes,mdn-syntaxhighlighter,image2,quicktable,simpleuploads,imagemaps,accordion,doksoft_stat,doksoft_backup,doksoft_button,doksoft_youtube,doksoft_maps,doksoft_html';
