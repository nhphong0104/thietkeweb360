...
$myform->add("cat_type","cat_type",0,0,$cat_type,1,translate_text("Please choose category type"),0,"");
...
<tr>
    ...
    <td class="form_text">
        <select name="cat_type" id="cat_type" class="form_control">
            ...
            ?>
                <option value="<?=$k?>" <? if($k == $cat_type){?>selected<? }?>><?=$v?></option>
            <?	
            }
            ?>
        </select>
...
<?=$form->text(translate_text("name"),"cat_name","cat_name",$cat_name,translate_text("name"),1,250,"",255)?>
<?=$form->text(translate_text("link"),"cat_link","cat_link",$cat_link,translate_text("link"),0,300,"",255)?>
<? 
